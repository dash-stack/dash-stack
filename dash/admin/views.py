...
def create_user_provider_admin(id):
    ...
    if form.validate_on_submit():
        ...
        role = keystone.roles.grant('4bb558518f6247bca7fbfbc7c0cce1ed',
                                    user=user.id,
                                    project=project.id)
